<?php
            ...
            // On récupère tout le contenu de la table billets
             $reponse = $bdd->query('SELECT * FROM billets ORDER BY date_billet DESC');
?>
...
<html>
    ...
    <body>
        ...
        <section>
        	<!--<div class="container">
        		<h1>Chapitre 1</h1>
        		<div id="date-article"><em>25/05/2020</em></div>
        		<p>"Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum."</p> 
        		<div id="commentaire"><a href="article-commentaire.php"><p><strong>Commentaire</strong></p></a></div>	
        	</div>
        	<div class="container">
        		<h1>Chapitre 2</h1>
        		<div id="date-article"><em>25/05/2020</em></div>
        		<p>"Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum."</p>
        		<div id="commentaire"><p><strong>Commentaire</strong></p></div>        		
        	</div>
        	<div class="container">
        		<h1>Chapitre 3</h1>
        		<div id="date-article"><em>25/05/2020</em></div>
            ...
            ?>
                <div class="container">
                    ...
                    <div id="commentaire"><a href="article-commentaire.php?billet= <?php echo $donnees['id']; ?>"><p><strong>Commentaire</strong></p></a></div>   
                </div>
            <?php
            }
